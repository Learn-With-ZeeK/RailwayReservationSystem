...
public class TrainService {
    ...
    static {
        allTrains.add(new Train(101,"Rajdhani",
                "Delhi","Kota",100,125, LocalDate.now()));
        allTrains.add(new Train(102,"Delhi-Express",
                "Delhi","Chennai",100,125, LocalDate.now()));
        allTrains.add(new Train(103,"Neelanchal-Express",
                "Delhi","Chennai",100,125, LocalDate.now()));
        allTrains.add(new Train(104,"SF-Bangalore",
                "Mumbai","Bangalore",100,125, LocalDate.now()));
        allTrains.add(new Train(105,"SF-Mumbai",
                "Bangalore","Mumbai",100,125, LocalDate.now()));
    }
